...
func TestReconcileGetFatalError(t *testing.T) {
	...
	res, err := rrcr.reconcile(ctrl.Request{})
...
func (m mockBGPPeer) ListBGPPeers() (*calicoApi.BGPPeerList, error) {
...
func (m mockBGPPeer) SaveBGPPeer(*calicoApi.BGPPeer) error {
...
func (m mockBGPPeer) RemoveBGPPeer(*calicoApi.BGPPeer) error {
